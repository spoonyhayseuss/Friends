...
public class i_friends_h_a_logIn extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public i_friends_h_a_logIn() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.enterText((android.widget.EditText) solo.getView("login_email"), "theFriended@android.com");

        solo.clearEditText((android.widget.EditText) solo.getView("login_password"));
        solo.enterText((android.widget.EditText) solo.getView("login_password"), "thefriended");
